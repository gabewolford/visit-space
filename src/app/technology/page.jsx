    ...
    return (
      <main className="flex-1 md:flex-col lg:flex-row lg:mx-[165px] mx-10 items-center justify-around py-12">
        <div className="flex flex-row w-full gap-6 text-[28px]">
          <h4 className={`${barlowCondensedBold.className} tracking-[4.725px] text-white-500/25`}>03</h4>
          <h4 className={`${barlowCondensed.className} tracking-[4.725px] uppercase`}>Space Launch 101</h4>
        </div>
